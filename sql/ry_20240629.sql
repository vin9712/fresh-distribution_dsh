...
insert into sys_menu values('4', '基础信息', '0', '1', 'infrastructure', null, '', '', 0, 0, 'M', '0', '0', '', 'star',    'admin', sysdate(), '', null, '基础设施目录');
insert into sys_menu values('5', '单据管理', '0', '2', 'order', null, '', '', 0, 0, 'M', '0', '0', '', 'build',    'admin', sysdate(), '', null, '单据管理目录');
