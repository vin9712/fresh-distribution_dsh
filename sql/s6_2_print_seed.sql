...
NULL, '(function(){var s=document.createElement("script");s.src="/jmreport/desreport_/ext/print-annotation.js?v=10";document.head.appendChild(s);})()', 'admin', sysdate(), 'admin', sysdate(), 0, NULL, NULL, 0, 0, NULL, NULL, NULL, '1', 0, 0, NULL);
