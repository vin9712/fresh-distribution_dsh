...
'{"loopBlockList":[],"querySetting":{"izOpenQueryBar":true,"izDefaultQuery":false},"recordSubTableOrCollection":{"group":[],"record":[],"range":[]},"printConfig":{"paper":"A4","width":210,"height":297,"definition":1,"isBackend":false,"marginX":10,"marginY":10,"layout":"portrait"},"hidden":{"rows":[],"cols":[]},"queryFormSetting":{"useQueryForm":true,"dbKey":"","idField":""},"dbexps":[],"dicts":[],"freeze":"A1","dataRectWidth":700,"isViewContentHorizontalCenter":false,"autofilter":{},"validations":[],"cols":{"0":{"width":110},"1":{"width":90},"2":{"width":70},"3":{"width":80},"4":{"width":90},"5":{"width":100},"len":100},"area":{"sri":0,"sci":5,"eri":0,"eci":5,"width":100,"height":25},"pyGroupEngine":false,"submitHandlers":[],"excel_config_id":"2099000000000000001","hiddenCells":[],"zonedEditionList":[],"rows":{"0":{"cells":{"0":{"merge":[0,5],"text":"送货单","style":1},"1":{},"2":{},"3":{},"4":{},"5":{}},"height":36},"1":{"cells":{"0":{"text":"客户：${hd.customerName}"},"2":{"text":"单号：${hd.code}","merge":[0,1]},"4":{"text":"日期：${hd.deliveryDate}"}}},"2":{"cells":{"0":{"text":"品名","style":1},"1":{"text":"规格","style":1},"2":{"text":"单位","style":1},"3":{"text":"数量","style":1},"4":{"text":"单价","style":1},"5":{"text":"金额","style":1}},"height":26},"3":{"cells":{"0":{"text":"#{dd.productName}"},"1":{"text":"#{dd.productSpec}"},"2":{"text":"#{dd.productUnit}"},"3":{"text":"#{dd.num}"},"4":{"text":"#{dd.price}"},"5":{"text":"#{dd.amount}"}},"height":24},"4":{"cells":{"4":{"text":"合计"},"5":{"text":"${hd.totalAmount}"}},"height":24},"len":100},"rpbar":{"show":true,"pageSize":"","btnList":[]},"fixedPrintHeadRows":[],"fixedPrintTailRows":[],"displayConfig":{},"background":false,"name":"sheet1","styles":[{"align":"center"},{"bgcolor":"#d9e1f2","align":"center"}],"freezeLineColor":"rgb(185, 185, 185)","merges":[]}',
