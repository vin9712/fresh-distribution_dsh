...
-- 打印任务表（t_print_task）【D-055 退役】
--   原 hiprint 试验件（template_id/order_id/template_content…）已随 D-055 打印包退役，
--   代码零引用；本节不再建表，尾部 [40] 节亦会 DROP。占位说明见 sql/s17_delivery_print_package.sql。
-- ============================================================
...
-- ============================================================
-- [31] S14/T7 第二轮 前端配套菜单  | 源: s14d_delivery_ui_menu.sql
-- ============================================================
...
-- ============================================================
-- 本脚本明确跳过 JimuReport 初始化（见头部【已跳过】），故以下几支不在这里执行：
...
-- ============================================================
-- [49] 配送点班次配置  | 源: s35_shift_config.sql
--      客户级开关 shift_enabled（仅大长江）+ 配送点班次 shift_codes（DAY/NIGHT）
--      + 订单班次 t_sale_order.shift_code + 字典 biz_shift_type；矩阵列 = 配送点 × 班次
-- ============================================================
