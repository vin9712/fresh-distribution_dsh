    ...
    <div class="frame" :key="key">
      ...
      <div class="content-panel" :style="{ zIndex: zIndex }">
        ...
        <div
          ...
          :style="{ background: `rgba(255,255,255,${contentOpacity}%)` }"
        >
          <i class="el-icon-rank rotate-90"></i>
        </div>
        <div
    ...
    <div>
      ...
      >
        <ul class="contextmenu-body">
          <li class="el-icon-caret-top" @click="handleDockTop"></li>
          <li class="el-icon-caret-left" @click="handleDockLeft"></li>
          <li class="el-icon-caret-bottom" @click="handleDockDown"></li>
          <li class="el-icon-caret-right" @click="handleDockRight"></li>
        </ul>
      </div>
      <div
  ...
  methods: {
    ...
    handleMoving($event) {
      ...
      requestAnimationFrame(() => {
        ...
        this.position.x =
          $event.clientX - this.mousePositionCopy.x + this.positionCopy.x;
        this.position.y =
          $event.clientY - this.mousePositionCopy.y + this.positionCopy.y;
        // 计算边界。
    ...
    inspectCursorStyle($event) {
      return window
        .getComputedStyle($event.target, "::after")
    ...
    westResizingHandle(dX) {
      ...
      // 计算极限值。
      const maxPositionX =
        this.positionCopy.x + this.sizeCopy.width - this.minWidth;
    ...
    northResizingHandle(dX, dY) {
      ...
      const maxPositionY =
        this.positionCopy.y + this.sizeCopy.height - this.minHeight;
      // eslint-disable-next-line prefer-destructuring
