<template>
   <div class="app-container">
      ...
      <!-- 添加或修改定时任务对话框 -->
      <el-dialog align-center :title="title" v-model="open" width="820px" append-to-body>
     ...
     <el-dialog align-center title="Cron表达式生成器" v-model="openCron" append-to-body destroy-on-close>
